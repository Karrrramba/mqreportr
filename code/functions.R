...
remove_prefix <- function(data){
  data <- data[, !(grepl("^(reporter|lfq|ratio)", colnames(data)) & !grepl("(corrected|normalized)", colnames(data)))]
